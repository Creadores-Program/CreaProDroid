...
function sendMessage(msg, isSpeak) {
    ...
    if(subPrompIAJson.genImg != null && subPrompIAJson.genImg.trim() != ""){
        try{
            ...
            responMSGIA += "<br/><button style='background: url(\"./resources/volume.png\") 50% 50% no-repeat; background-size: contain;' onclick='Android.openUrl(\""+genimghjkfr+"\");'></button><img src='"+genimghjkfr+"' alt='Imagen Generada'/>";
        }catch(e){
